const context = {
    ...
    instruments: [
      {
        image: 'ddp-ZJR--G6nXvK-unsplash.jpg',
      ...
      },
      {
        ...
        name:  'Violin',
        description: 'A versatile that is suited for any and all occasions. Those wearing tuxedos can strum together a classic. Others who prefer overalls can call it a fiffle and play some folk songs.',
        price: '$245.00'
      }
    ]
  };
